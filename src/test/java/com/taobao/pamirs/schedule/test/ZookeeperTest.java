...
public class ZookeeperTest {
    ...
    public void testCloseStatus() throws Exception {
        ZooKeeper zk = new ZooKeeper("192.168.195.34:2181", 3000,
    ...
    public void testACL() throws Exception {
        ZooKeeper zk = new ZooKeeper("192.168.195.34:2181", 3000, new ScheduleWatcher(null));
        ...
        if (zk.getData("/abc", false, null) == null) {
            zk.create("/abc", "haha".getBytes(), acls, CreateMode.PERSISTENT);
        }else{
            zk.delete("/abc", 0);
            zk.create("/abc", "haha".getBytes(), acls, CreateMode.PERSISTENT);
        }
        String data = new String(zk.getData("/abc", false, null));
